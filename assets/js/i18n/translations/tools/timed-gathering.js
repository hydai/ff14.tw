...
window.TimedGatheringTranslations = {
    zh: {
        ...
        confirmDeleteList: '確定要刪除清單「{0}」嗎？',
        confirmClearList: '確定要清空清單「{0}」嗎？',
        operationCannotUndo: '此操作無法復原！',
        willRemoveItems: '將移除 {0} 個採集物',
        ...
        listNameTooLong: '清單名稱不能超過 {0} 個字元',
        ...
        successImportedLists: '成功匯入 {0} 個清單',
        sourceListNotExist: '來源清單不存在',
        listCopiedSuccess: '清單複製成功',
        addedItemsToList: '已新增 {0} 個項目到目標清單',
        listMaxItems: '清單最多只能包含 {0} 個項目',
